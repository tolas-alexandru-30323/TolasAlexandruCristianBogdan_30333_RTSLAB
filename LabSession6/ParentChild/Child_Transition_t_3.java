...
public class Child_Transition_t_3 implements TransitionTemplate {
	...
	public Child_Transition_t_3(String name, PlaceHandlerTemplate PH, Integer delay) {
		this.Init(name, PH);
		this.SetDelay(delay);
	}

	public Child_Transition_t_3(String name, PlaceHandlerTemplate PH, Integer eet, Integer let) {
		this.Init(name, PH);
	...
	public Boolean TransitionGuardsMappings() {
		...
		if (!PH.GetPlaceByName("p_23").IsNull()&& (Float)(PH.GetPlaceByName("p_23").Get())<2.0f) {
			...
			PH.GetPlaceByName("p_24").Set(PH.GetPlaceByName("p_23").Get());
			PH.GetPlaceByName("p_21").Set(PH.GetPlaceByName("p_23").Get());
